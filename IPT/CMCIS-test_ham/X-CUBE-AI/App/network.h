...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 30, 32, 1, 1, NULL), \
}
#define AI_NETWORK_IN_SIZE { \
  (30 * 32 * 1), \
}
#define AI_NETWORK_IN_1_SIZE  (30 * 32 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((30 * 32 * 1) * 4)
...
#define AI_NETWORK_OUT_1_SIZE  (1 * 1 * 5)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 5) * 4)
