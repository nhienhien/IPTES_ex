...
#define PIN_PWR_GPIO_Port
#define PIN_PWR_Pin
#define PIN_WAKEUP_GPIO_Port
#define PIN_WAKEUP_Pin

char Rx_Buffer[MAX_ARRAY] = {0};
char Rx_Data[2] = {0};
char lat_Array[10] = {0};
char lng_Array[10] = {0};
char Latitude_ARR[12] 	= "";
char Longtitude_ARR[12] = "";
float lat_Location;
float lng_Location;
//--------------------------DelayMicro-----------------------------//
...
uint8_t take_Coordinate(UART_HandleTypeDef *huart, char *Rx_Buffer)
{
...
uint8_t convert_Coordinate(UART_HandleTypeDef *huart, char *lat_Array, char *lng_Array)
{
